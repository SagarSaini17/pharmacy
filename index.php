...
<body>
  ...
  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img src="images/carousel1.png" class="d-block w-100" style="height: 270px;">
      </div>
      <div class="carousel-item">
        <img src="images/carousel3.png" class="d-block w-100" style="height: 270px;">
      </div>
    </div>
  ...
  <div class="container-fluid ">
    ...
    <div class="row" id="cards" style="justify-content: space-evenly;">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-4" style="padding-left: 20px;">
          ...
          <h1 style="color:  rgb(47,79,79); font-weight: bold;"> 21 + </h1>
          <h5 style="color:  rgb(47,79,79);">Registr User As Of Now</h5>
        ...
        <div class="col-sm-4" style="padding-left: 20px; border-bottom-right-radius: 2px;">
          ...
          <h1 style="color:  rgb(47,79,79); font-weight: bold;"> 20 </h1>
          <h5 style="color:  rgb(47,79,79);">Pharmacy Order </h5>
        </div>
        <div class="col-sm-4" style="padding-left: 60px;">
          <img src="https://assets.pharmeasy.in/web-assets/dist/773ae9c5.svg">
          <h1 style="color:  rgb(47,79,79); font-weight: bold;"> 50+ </h1>
          <h5 style="color:  rgb(47,79,79);">SKUs Sold in Q1FY23</h5>
        </div>
      </div>
    </div>
